  ...
  <div class="kll">
    <div class="form-container">
      ...
      <form id="recipeForm" @submit.prevent="addRecipe">
        ...
        <div class="form-group">
          <label for="ingredients">Ingredients (follow this format "nom quantité unité"):</label>
          <textarea v-model="ingredients" id="ingredients" name="ingredients" required></textarea>
        </div>
        <div class="form-group">
          <label for="instructions">Instructions (split them with new lines):</label>
        ...
        <div class="form-group">
          <label for="image">Image link (it must be a google link):</label>
          <input v-model="imageurl" type="text" id="image" name="image" required>
        </div>
        <div class="op">
